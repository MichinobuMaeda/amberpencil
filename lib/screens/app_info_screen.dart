...
class AppInfoScreen extends StatelessWidget {
  ...
  const AppInfoScreen({Key? key, required this.route}) : super(key: key);
...
//                       height: 48,
//                     ),
//                     applicationName: 'Amber pencil',
//                     applicationVersion: version,
//                     applicationLegalese: 'Copyright (c) 2021 Michinobu Maeda',
//                   );
//                 },
//                 icon: const Icon(Icons.copyright),
//                 label: const Text('著作権'),
